...
class ReportManager {
    ...
    public function submitReport(Player $player, string $type, string $description): void {
        ...
        $this->plugin->getServer()->getAsyncPool()->submitTask(new SaveReportTask($filePath, $data));
        ...
        if ($this->plugin->getConfig()->getNested("discord.enabled")) {
            ...
            $this->plugin->getServer()->getAsyncPool()->submitTask(new DiscordWebhookTask($url, $data));
        }
